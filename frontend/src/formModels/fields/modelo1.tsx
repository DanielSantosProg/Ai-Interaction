...
import type { Modelo1FormValues } from "../models";
...
interface Modelo1FieldsProps {
    form: UseFormReturn<Modelo1FormValues>;
    empresas: Empresa[];
...
export const Modelo1Fields: React.FC<Modelo1FieldsProps> = ({
    form,
    empresas,
    estabelecimentos,
    localizacoes,
